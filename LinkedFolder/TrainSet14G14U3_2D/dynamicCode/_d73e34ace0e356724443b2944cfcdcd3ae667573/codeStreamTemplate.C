...
//{{{ begin codeInclude
#line 0 "/mnt/c/Users/Nigel/Documents/NTUFYP2019/NNBasedSteadyStateSurrogateCFD/LinkedFolder/TrainSet14G14U3_2D/system/blockMeshDict.#codeStream"
...
extern "C"
{
    void codeStream_d73e34ace0e356724443b2944cfcdcd3ae667573
    (
        Ostream& os,
...
pointField points(16);
        ...
        points[5]  = point(9, 5, 0.5);
        points[6]  = point(9, 8, 0.5);
        points[7]  = point(5, 8, 0.5);
        points[8]  = point(5, 0, 0.5);
        points[9]  = point(9, 0, 0.5);
        points[10] = point(25.5, 5, 0.5);
        points[11] = point(25.5, 8, 0.5);
        points[12] = point(9, 12.7, 0.5);
