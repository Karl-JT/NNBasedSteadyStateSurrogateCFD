...
//{{{ begin codeInclude
#line 0 "/mnt/c/Users/Nigel/Documents/NTUFYP2019/LinkedFolder/TrainSet12G1U3/system/blockMeshDict.#codeStream"
...
extern "C"
{
    void codeStream_c53ff285930cae3cd5c171cf8691ebbee1cc7e9f
    (
        Ostream& os,
...
pointField points(16);
        ...
        points[4]  = point(5, 6, 0.5);
        points[5]  = point(6, 6, 0.5);
        points[6]  = point(6, 7, 0.5);
