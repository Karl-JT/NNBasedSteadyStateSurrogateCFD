...
//{{{ begin codeInclude
#line 0 "/mnt/c/Users/Nigel/Documents/NTUFYP2019/NNBasedSteadyStateSurrogateCFD/LinkedFolder/TrainSet16G1U3T_2D/system/blockMeshDict.#codeStream"
...
extern "C"
{
    void codeStream_ef116a413034d99a2d6ff9b36c801c1e1e4faa29
    (
        Ostream& os,
...
pointField points(16);
        ...
        points[6]  = point(8, 6, 0.5);
        points[7]  = point(7, 6, 0.5);
