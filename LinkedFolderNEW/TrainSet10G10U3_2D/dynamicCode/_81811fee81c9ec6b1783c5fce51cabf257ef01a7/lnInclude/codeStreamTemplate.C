...
//{{{ begin codeInclude
#line 0 "/mnt/c/Users/Nigel/Documents/NTUFYP2019/NNBasedSteadyStateSurrogateCFD/LinkedFolder/TrainSet10G10U3_2D/system/blockMeshDict.#codeStream"
...
extern "C"
{
    void codeStream_81811fee81c9ec6b1783c5fce51cabf257ef01a7
    (
        Ostream& os,
...
pointField points(16);
        ...
        points[6]  = point(9, 7, 0.5);
        points[7]  = point(5, 7, 0.5);
