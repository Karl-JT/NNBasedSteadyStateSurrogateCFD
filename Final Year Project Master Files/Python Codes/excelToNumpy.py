...
X_array = np.zeros((trainingCasesListLen, 101, 201))
Y_array = np.zeros((trainingCasesListLen, 101, 201))
...
for count in range(trainingCasesListLen):
    ...
    for x in range(len(rawData)):
        ...
        #Y_array[count, int(tempLine[1]),int(tempLine[0])] = (tempLine[3],tempLine[4],tempLine[5])
